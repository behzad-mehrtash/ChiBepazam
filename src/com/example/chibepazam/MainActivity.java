...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fDB.open();//male chie? key bayad gozasht? faghat sare neveshtan? ya unvar ke mikhuim tu firstPage ham bayad bezarim?
		fDB.createFood("خورشت بادمجان", "۱۲۰ دقیقه", "۴ نفر", "بادمجون خورشتی:نیم کیلو،گوشت قرمز تیکه شده:نیم کیلو،گوجه فرنگی:۳عدد،پیاز ریز شده:یک عدد،زعفران و نمک و روغن:مقداری،رب گوجه فرنگی:دو قاشق غذاخوری،آب:۴ لیوان،آبغوره:نصف پیمانه",
				...
				"bademjan.JPG");
		fDB.createFood("کتلت سیب زمینی", "۳۰ دقیقه", "۴ نفر", "سیب زمینی آبپز:600گرم،تخم مرغ:1عدد،نمک  و فلفل و زردچوبه:به میزان لازم،گوشت چرخ کرده:150گرم،جعفری خورد شده:چند شاخه،پیاز:۱عدد،رب:۱قاشق غذاخوری،نمک و فلفل و ادویه ی گوشت:به میزان لازم",
